...
export class ProfessorService {
  ...
  getProfessorById(id: number): Observable<ProfessorResponse> {
  ...
  bulkUploadProfessor(file: File): Observable<bulkUploadProfessorResponse> {
    const fd = new FormData();
    fd.append('file', file);

    return this.http.post<bulkUploadProfessorResponse>(
      this.bulkUploadProfessorUrl,
      fd,
      { headers: this.authHeaders() }
    );
  }
